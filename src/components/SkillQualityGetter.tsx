import { SkillQualityInfoRoot, SkillQualityInfo, SkillQuality, SkillQualityDetail } from "../Type/SkillQualityType";
...
export async function GetSkillQuality(gemNames: string[]): Promise<Map<string, SkillQuality>> {
  let url = GetPOEWikiAPIUrl(gemNames)
  ...
  let result: Map<string, SkillQuality> = new Map<string, SkillQuality>()
